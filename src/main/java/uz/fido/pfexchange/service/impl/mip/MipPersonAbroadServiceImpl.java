...
import uz.fido.pfexchange.repository.mip.MipPersonAbroadRepository;
...
public class MipPersonAbroadServiceImpl implements MipPersonAbroadService {

    private final MipPersonAbroadRepository repository;
