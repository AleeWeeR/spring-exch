...
public class ChargeServiceImpl implements ChargeService {
    ...
    @Override
    public ChargeResponseDto getChargesInfo(ChargeRequestDto request) {
        ...
        try {
            return jdbcTemplate.execute((Connection connection) -> {
                ...
                try (CallableStatement cs = connection.prepareCall(sql)) {
                    ...
                    return objectMapper.readValue(jsonResponse, ChargeResponseDto.class);
    ...
    @Override
    public ChargeHistoryResponseDto getChargedInfo(ChargeRequestDto request) {
        ...
        try {
            return jdbcTemplate.execute((Connection connection) -> {
                ...
                try (CallableStatement cs = connection.prepareCall(sql)) {
                    ...
                    // Parse JSON response to DTO
                    return objectMapper.readValue(jsonResponse, ChargeHistoryResponseDto.class);
     ...
     */
    private String buildXmlInput(ChargeRequestDto request) {
        return "<Data>" +
